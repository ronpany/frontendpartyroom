...
function editarRespuesta(items) {
    ...
    let boat = "<strong>Información Botes</strong><br>Marca" + items.boat.brand + "<br>Nombre: " + items.boat.name + "<br>Descripción: " + items.boat.description
