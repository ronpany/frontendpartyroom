 ...
 * endpoint: http://localhost:8081/api/Boat/all
 */
...
/**
 * Retorna un listado de Botecletas en formato html <option value=id Botecleta>Nombre Botecleta</option>
 * @param {*} items listado de objetos json con información de clientes
 * @returns html con lista de <option value=id Botecleta>Nombre Botecleta</option>
 *          para pintar las lista de Botecletas en el taga html <select> de la pagina
 *          que lo requiera
 *          
 */
function armaListaBotes(items) {
    $("#listado").html("");
    $("#listado").show(500);
    //define variable javascript con la definicion inicial de la tabla, la primera fila y los
    //encabezados o títulos de la tabla
    var lista = ` <option value="">--Selecciona un Bote--</option>`;
